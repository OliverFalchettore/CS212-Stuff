...
public class Money implements Comparable<Money> {
	...
	public void add(Money other) {
		...
		int sum_cents = this.cents + other.cents;
		
		if(sum_cents >= 100) {
			this.cents += (sum_cents % 100);
		}
		
		this.dollars += (sum_cents / 100);
	}
	...
	public int compareTo(Money other) {
		 ...
		 */
	     ...
	     // Step 2: If dollars are equal, compare cents
